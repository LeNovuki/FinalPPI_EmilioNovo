...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                ...
                <p class="text-navbar tittles-pages-logo">NOVO Electronics</p>
            </div>
            <div class="col-xs-8">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en NOVO Electronics</h4>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">NOVO Electronics</h3>
